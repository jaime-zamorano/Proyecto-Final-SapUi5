sap.ui.define([
	...
	function onAscendEmployee(oEvent){
		if(!this.ascendDialog){
			this.ascendDialog = sap.ui.xmlfragment("Empleados/RecursoHumano/fragment/AscendEmployee", this);
			this.getView().addDependent(this.ascendDialog);
		}
		this.ascendDialog.setModel(new sap.ui.model.json.JSONModel({}),"newAscend");
   ...
   //se suben los parametros slug para el servicio odata 
	...
	return Controller.extend("Empleados.RecursoHumano.controller.ShowEmployee", {
		onInit: onInit,
		pressBack : pressBack,
		searchEmployee : searchEmployee,
		selectEmployee : selectEmployee,
		deleteEmployee : deleteEmployee,
		onAscendEmployee : onAscendEmployee,
		onCloseAscendDialog : onCloseAscendDialog,
        addAscend : addAscend,
        onChange : onChange,
